...
Modern applications are increasingly designed **to keep us engaged**. *Endless scrolling, constant notifications, crowded interfaces, recommendations, and an overwhelming amount of information* can make it difficult to simply focus on what we actually came to do.

I believe **software does not always need to demand our attention.**

Serene was created from this idea: to build a study application that is **direct, calm, and practical**. Instead of filling the screen with information and features competing for the user's attention, Serene aims to provide only what is necessary to organize and track studying.

> The goal is simple: help students study without becoming another distraction.
